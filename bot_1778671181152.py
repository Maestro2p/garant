...
channel_handler = ChannelLogHandler(bot, load_log_channel)
channel_handler.setFormatter(logging.Formatter('%(asctime)s %(levelname)s [%(name)s]: %(message)s'))
root_logger.addHandler(channel_handler)
